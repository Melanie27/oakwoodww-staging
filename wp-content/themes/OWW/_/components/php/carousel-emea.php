									...
									<div id="carousel-example-generic" class="carousel slide">
										...
										<div class="carousel-inner"> 
											...
											<div class="item active">
												<div class="row">
													<?php $emea_slides = new WP_Query( array(
														'post_type' => 'emea_slides',
														'posts_per_page' => '3',
														'meta_key' => 'emea_slide_position',
														'meta_value' => '1'			
													));?>
													<?php query_posts('post_type=emea_slides'); while ($emea_slides->have_posts()): $emea_slides->the_post(); ?>
													<?php for ($i = 0; $i < 1; $i++) {													
													echo '<div class="col-lg-4 col-md-4 col-sm-3 col-xs-6">';
														the_post_thumbnail('carouselsize');
														echo '<div class="carousel-caption">';
															echo '<h3>';
																echo esc_html( get_post_meta( get_the_ID(), 'emea_slide_blurb', true ) );
															echo '</h3>';
														echo '</div>';
