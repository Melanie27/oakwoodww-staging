...
jQuery(document).ready(function($){
	jQuery('#landing-page-hero').click(function () {
		$('.mainarticle').show();
		$('.mainarticle').load('../wp-content/themes/u-design/landing_modal.html #mainarticle', function() {
			$('#theDark, .mainarticle').fadeIn(500);
		
			$('#theDark, .close-button').click(function(){
...
<?php                   else : ?>
                            <div class="site-name"><a  title="<?php bloginfo('name'); ?>" class="pngfix" href="<?php echo get_bloginfo('url'); ?>/landing-page/"><?php bloginfo('name'); ?></a></div>
<?php                   endif; ?>
                    </div>
...
<?php                   /*udesign_nav();*/ // this function calls the main menu ?>
						...
						<?php wp_nav_menu( array( 'container_class' => 'navigation-menu',
