    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
        <tr valign="top">
         <td width="15%" height="100%" style="border-right:dotted black 1px;" id="field_types">
            ...
            <tr>
            <td align="center" onClick="addRow('file_upload')" class="field_buttons" id="table_file_upload"><img src="<?php echo $form_file_url; ?>/images/file_upload.png" style="margin:5px" id="img_file_upload"/></td>
            ...
            <tr>
            <td align="center" onClick="addRow('map')" class="field_buttons" id="table_map"><img src="<?php echo $form_file_url; ?>/images/map.png" style="margin:5px" id="img_map"/></td>  
...
var keyCode = event.keyCode ? event.keyCode : event.which ? event.which : event.charCode;
   ...
   <td style="width:140px;">
    ...
    <?php if($old_version) {?> <td  style="width:90px; text-align:right;"><input class="button-primary action" type="button" value=" Update Forms" name="update_forms" onclick="window.location.href='admin.php?page=Form_maker&task=update'" /></td><?php }?>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
		...
		<table border="0" cellpadding="0" cellspacing="3" width="100%">
            ...
            <tr>
            <td align="center" onClick="addRow('file_upload')" style="cursor:pointer" id="table_file_upload" class="field_buttons"><img src="<?php echo plugins_url("images/file_upload.png",__FILE__) ?>" style="margin:5px" id="img_file_upload"/></td>
